...
public class AdminController {
    ...
    public String adminElementPost(ElementVO elementVO, Model model){
        ...
        saveElementTypesAndElementVO( elementVO );
    ...
    public String adminElementLists(Model model){
    ...
    public String elementTypeEdit(@PathVariable int id, Model model){
        ...
        return "admin/element/element_edits";
    }
    ...
    public String elementTypeUpdate(ElementType elementType,
        ...
        //if new element has a value add it to the list
        ...
        for(int i = 0; i < elementType.getElementList().size(); i++){
            ...
            if(elementType.getElementList().get( i ).getElementName().equals( "" )){
                //element name is black remove it from the list
    ...
    //Saving elements and elementType to database(H2)
    private void saveElementTypesAndElementVO(ElementVO elementVO){
